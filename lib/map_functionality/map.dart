...
class _MapViewState extends State<MapView> {
  ...
  _getCurrentLocation() async {
    await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
      ...
      await _getAddress(_currentPosition, true);
    }).catchError((e) {
      print(e);
    });
  }
  ...
  _getAddress(Position currentPosition, bool flag) async {
    try {
                        ...
                        children: <Widget>[
                          ...
                          _textField(
                              ...
                              suffixIcon: IconButton(
                                ...
                                onPressed: () {
                                  _getAddress(_currentPosition, true);
                                },
                              ),
                          ...
                          ElevatedButton(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: Color.fromARGB(255, 245, 141, 141),
                                  fontSize: 20.0,
                                ),
                              ),
                            ),
